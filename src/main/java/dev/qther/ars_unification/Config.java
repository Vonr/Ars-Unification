...
public class Config {
    ...
    private Config(ModConfigSpec.Builder builder) {
        ...
        IMMERSIVE_ENGINEERING_CRUSHER = builder.comment("Priority of Immersive Engineering's Crusher recipes, -1 to disable").defineInRange("immersiveengineering.sawmill", 85, -1, 2147483647);

        builder = builder.pop().push("cut");
        MEKANISM_SAWMILL = builder.comment("Priority of Mekanism's Sawmill recipes, -1 to disable").defineInRange("mekanism.sawmill", 100, -1, 2147483647);
        ...
        IMMERSIVE_ENGINEERING_SAWMILL = builder.comment("Priority of Immersive Engineering's Sawmill recipes, -1 to disable").defineInRange("immersiveengineering.sawmill", 80, -1, 2147483647);
